...
contract Escrow {
    ...
    // --- State Variables ---
    address public immutable depositor;     // Project Owner
    address public immutable beneficiary;   // Freelancer
    ...
    function fund() external {
        ...
        // Pulls funds from the depositor. The depositor must have approved this Escrow
        // contract to spend their tokens beforehand.
    ...
    function release() external {
        // The Project contract, controlled by the depositor, is the caller.
    ...
    function resolveDispute(address winner) external {
        ...
        if (winner == beneficiary) {
            ...
            // Assume the depositor wins if the beneficiary does not
